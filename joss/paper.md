...
![Simplified workflow diagram illustrating data flow through the `assetra` package.](assetra-class-interface.drawio.png)
...
![Derived types used in the `assetra` model.](assetra-inherited-types.drawio.png)
